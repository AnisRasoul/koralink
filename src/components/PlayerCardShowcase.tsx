  ...
  return (
    <section ref={ref} className="py-24 relative overflow-hidden">
      ...
      <div className="section-container relative z-10">
        {/* Section Header */}
        <div className={`text-center max-w-3xl mx-auto mb-16 scroll-slide-up ${isVisible ? 'is-visible' : ''}`}>
        ...
        <div className="flex flex-wrap justify-center gap-6 lg:gap-8">
          {samplePlayers.map((player, index) => (
            <div
              key={index}
              className="player-card-gold w-[200px] sm:w-[220px] animate-slide-up opacity-0 rounded-2xl overflow-hidden"
              style={{ 
